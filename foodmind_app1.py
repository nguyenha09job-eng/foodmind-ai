...
st.set_page_config(
    page_title="FoodMind AI - Đăng nhập",
    page_icon="🥗",
    layout="wide",
...
# Đoạn mã HTML/CSS mô phỏng giao diện Đăng nhập
html_code = """
<!DOCTYPE html>
<html lang="vi">
<head>
...
<style>
  * { margin: 0; padding: 0; box-sizing: border-box; }
  ...
  .phone-frame {
    width: 390px;
    height: 844px;
    background: #ffffff; /* Nền trắng sáng theo ảnh */
    border-radius: 48px;
...
<div class="phone-frame">
  ...
  <div class="auth-tabs">
    ...
    <div class="tab inactive" onclick="alert('Chuyển tab Đăng ký')">Đăng ký</div>
  </div>

  <!-- Welcome -->
  <h1 class="welcome-title">Chào mừng! 👋</h1>
  <p class="welcome-desc">Nhập số điện thoại để tiếp tục trải nghiệm AI Food</p>
  ...
  <div class="form-group">
    ...
    <div class="input-wrapper">
      ...
      <input type="tel" id="phone" class="input-field" placeholder="09xx xxx xxx">
    </div>
  </div>
  ...
  <div class="form-error" id="login-error">Vui lòng điền đủ thông tin</div>
